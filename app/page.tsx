...
export default function Home() {
  ...
  return (
    <main id="top" className="flex min-h-screen flex-col items-center">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center">
            <SmoothScrollLink
              ...
              onClick={() => trackButtonClick("nav_top", "mobile_menu")}
            >
              <Image
          ...
          <div className="hidden md:flex space-x-8">
            <SmoothScrollLink
              ...
              onClick={() => trackButtonClick("nav_features", "desktop_menu")}
            >
              Features
            </SmoothScrollLink>
            <SmoothScrollLink
              href="#pricing"
              className="text-gray-700 hover:text-purple-700 transition-colors"
              onClick={() => trackButtonClick("nav_pricing", "desktop_menu")}
            >
              Pricing
            </SmoothScrollLink>
            <SmoothScrollLink
              href="#faq"
              className="text-gray-700 hover:text-purple-700 transition-colors"
              onClick={() => trackButtonClick("nav_faq", "desktop_menu")}
            >
              FAQ
            </SmoothScrollLink>
          </div>
            ...
            <div className="px-4 py-3 space-y-3">
              <SmoothScrollLink
                ...
                onClick={() => {
                  ...
                  trackButtonClick("nav_features", "mobile_menu")
                }}
              >
                Features
              </SmoothScrollLink>
              <SmoothScrollLink
                ...
                onClick={() => {
                  setMobileMenuOpen(false)
                  trackButtonClick("nav_pricing", "mobile_menu")
                }}
              >
                Pricing
              </SmoothScrollLink>
              <SmoothScrollLink
                ...
                onClick={() => {
                  setMobileMenuOpen(false)
                  trackButtonClick("nav_faq", "mobile_menu")
                }}
              >
                FAQ
              </SmoothScrollLink>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center md:justify-start">
                <EligibilityQuizController>
                  <Button
                    ...
                    onClick={() => trackButtonClick("eligibility_quiz", "hero")}
                  >
                ...
                <Button
                  ...
                  asChild
                  onClick={() => {
                    handleBetaSignup("hero")
                    trackButtonClick("beta_signup", "hero")
                    trackExternalLink("https://forms.office.com/r/KNDUcFg5Vw", "hero")
                  }}
                >
      ...
      <SectionTracker sectionName="problem">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold mb-2">Expensive Immigration Lawyers</h3>
                    <p className="text-gray-600 text-sm md:text-base">
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold mb-2">Time-Consuming Process</h3>
                    <p className="text-gray-600 text-sm md:text-base">
                      Writing compelling petition letters and gathering evidence takes 3-6 months without proper
                      guidance.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold mb-2">Generic Templates Don't Work</h3>
                    <p className="text-gray-600 text-sm md:text-base">
              ...
              <div className="order-2 lg:order-1">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-semibold mb-2">Smart Recommendation Letter System</h3>
                      <p className="text-gray-600 text-sm md:text-base">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h3 className="text-lg md:text-xl font-semibold mb-2">Structured Step-by-Step Process</h3>
                      <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
              ...
              <div className="border border-gray-200 rounded-xl p-6 md:p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-sm text-gray-600 mb-4">Perfect for DIY petitioners with strong qualifications</p>

                <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">AI-powered petition builder</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">Secure recommender portal</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">USCIS-compliant templates</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">Professional PDF export</span>
                  </li>
                </ul>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    trackButtonClick("pricing_essential", "pricing")
                    trackExternalLink("https://forms.office.com/r/KNDUcFg5Vw", "pricing")
                  }}
                >
                  <a href="https://forms.office.com/r/KNDUcFg5Vw" target="_blank" rel="noopener noreferrer">
              ...
              <div className="border-2 border-purple-500 rounded-xl p-6 md:p-8 shadow-lg relative">
                <div className="absolute top-0 right-0 bg-purple-500 px-3 md:px-4 py-1 rounded-bl-lg rounded-tr-lg font-medium text-sm text-white">
                  MOST POPULAR
                </div>
                ...
                <p className="text-sm text-gray-600 mb-4">Best value with expert guidance and support</p>

                <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">Everything in Essential</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base">
                      <strong className="text-white text-base font-bold">3 professional recommendation letters</strong>
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm md:text-base font-bold">Priority email support</span>
                  </li>
                </ul>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    trackButtonClick("pricing_pro", "pricing")
                    trackExternalLink("https://forms.office.com/r/KNDUcFg5Vw", "pricing")
                  }}
                >
                  <a href="https://forms.office.com/r/KNDUcFg5Vw" target="_blank" rel="noopener noreferrer">
              ...
              <div className="border border-gray-200 rounded-xl p-6 md:p-8 hover:shadow-lg transition-shadow duration-300 bg-gradient-to-b from-gray-50 to-white">
                ...
                <div className="flex items-end mb-4 md:mb-6">
                  <span className="text-3xl md:text-4xl font-bold text-white">$1,499</span>
                  <span className="text-gray-500 ml-2">one-time</span>
                </div>
                <p className="text-sm text-gray-600 mb-4">Complete solution with legal oversight</p>
                ...
                <Button
                  className="w-full bg-amber-500 hover:bg-amber-600 font-semibold text-white"
                  asChild
                  onClick={() => {
                    handlePricingClick("Pro Max")
                    handleBetaSignup("pricing-promax")
                    trackButtonClick("pricing_promax", "pricing")
                    trackExternalLink("https://forms.office.com/r/KNDUcFg5Vw", "pricing")
                  }}
                >
                  <a href="https://forms.office.com/r/KNDUcFg5Vw" target="_blank" rel="noopener noreferrer">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <Button
              ...
              asChild
              onClick={() => {
                handleBetaSignup("final-cta")
                trackButtonClick("final_cta", "hero")
              }}
            >
              <a href="https://forms.office.com/r/KNDUcFg5Vw" target="_blank" rel="noopener noreferrer">
            ...
            <EligibilityQuizController>
              <Button
                ...
                onClick={() => trackButtonClick("eligibility_quiz", "final_cta")}
              >
                Take Free Eligibility Quiz
              </Button>
            </EligibilityQuizController>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/resume-analyzer" className="hover:text-white transition-colors text-sm md:text-base">
                    Resume Analyzer
                  </Link>
                </li>
                <li>
                  <Link href="#faq" className="hover:text-white transition-colors text-sm md:text-base">
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link href="#pricing" className="hover:text-white transition-colors text-sm md:text-base">
                    Pricing
                  </Link>
                </li>
              </ul>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    ...
                    className="hover:text-white transition-colors text-sm md:text-base"
                    onClick={() => {
                      handleBetaSignup("footer")
                      trackButtonClick("beta_signup", "footer")
                      trackExternalLink("https://forms.office.com/r/KNDUcFg5Vw", "footer")
                    }}
                  >
                    Join Beta Program
                  </a>
