...
import { ChevronLeft, Download, Mail, CheckCircle, AlertCircle, TrendingUp, FileText, Award, Users, BookOpen, Lightbulb, Building, DollarSign, LinkIcon } from 'lucide-react'
      ...
      {resumeDataParsed && (
        <div className="bg-white border rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-lg font-semibold text-gray-900">Parsed Resume Data (AI)</h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="p-3 rounded-md bg-purple-50">
              ...
              <p className="text-purple-800">
                {resumeDataParsed.publications?.count ?? 0} item(s)
              </p>
            ...
            <div className="p-3 rounded-md bg-amber-50">
              ...
              <p className="text-amber-800">
                {resumeDataParsed.awards?.count ?? 0} item(s)
              </p>
            ...
            <div className="p-3 rounded-md bg-blue-50">
              ...
              <p className="text-blue-800">
                {resumeDataParsed.patents?.count ?? 0} item(s)
              </p>
